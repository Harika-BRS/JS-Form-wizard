...
function text(textValid) {
  ...
  let show = textValid.name + "error";
   let minLength = textValid.getAttribute("min") || 2;
   let maxLength = textValid.getAttribute("max") || 50;
   if (type == "text") {
     let textValue = textValid.value;
     let textValueLength = textValue.length;
     let regex = /^[a-zA-Z]+$/;
     if (!regex.test(textValue)) {
       document.getElementById(show).innerHTML = "&#10008; only characters allowed";
       document.getElementById(show).style.color = "red";
       return false;
     } else if (textValueLength < minLength) {
       document.getElementById(show).innerHTML = "&#10008; minimum " + minLength + " chars";
       document.getElementById(show).style.color = "red";
       return false;
     } else if (textValueLength > maxLength) {
       document.getElementById(show).innerHTML = "&#10008; maximum " + maxLength + " chars";
       document.getElementById(show).style.color = "red";
       return false;
     } else {
